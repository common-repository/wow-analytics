...
function wow_wowanalytics_options_page()
{
    ...
    <div class="wrap">
        ...
        <div id="wow_head_method_detect" class="notice-warning below-h2 notice is-dismissible" style="display: none;">
            <p>
                <strong>Unable to detect wp_head() method in your theme. This means that tracking may not work.</strong>
            </p>
